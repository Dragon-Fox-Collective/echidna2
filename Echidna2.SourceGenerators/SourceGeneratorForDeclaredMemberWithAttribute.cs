// Stolen from https://github.com/Cat-Lips/GodotSharp.SourceGenerators
...
{
	public abstract class SourceGeneratorForDeclaredMemberWithAttribute<TAttribute, TDeclarationSyntax, TSymbol> : IIncrementalGenerator
		...
		where TSymbol : ISymbol
	{
		...
		protected abstract (string GeneratedCode, DiagnosticDetail Error) GenerateCode(Compilation compilation, SyntaxNode node, TSymbol symbol, AttributeData attribute, AnalyzerConfigOptions options);

		private (string GeneratedCode, DiagnosticDetail Error) _GenerateCode(Compilation compilation, SyntaxNode node, TSymbol symbol, AttributeData attribute, AnalyzerConfigOptions options)
		{
			try
			{
